...
use BohnMedia\ContaoViteBundle\Routing\ProxyRouteLoader;
...
class Plugin implements BundlePluginInterface, RoutingPluginInterface, ExtensionPluginInterface
{
    ...
    public function getRouteCollection(LoaderResolverInterface $resolver, KernelInterface $kernel): ?RouteCollection
    {
        ...
        $loader = $resolver->resolve(ProxyRouteLoader::TYPE, ProxyRouteLoader::TYPE);

        if (false === $loader) {
            return null;
        }

        return $loader->load(ProxyRouteLoader::TYPE, ProxyRouteLoader::TYPE);
    }
